...
We as members, contributors, and maintainers of Dryline pledge to make
...
reported to the project maintainer at **[mail@willhin.es](mailto:mail@willhin.es)**.
...
available at
<https://www.contributor-covenant.org/version/2/1/code_of_conduct/>. For the
full text — including the detailed enforcement guidelines and the complete list
of community-impact consequences — see the canonical document linked above.
